...
import hisdroid.edgefunc.intent.IntentGetFloatEdge;
			...
			if (callNode.equivTo(base) && returnSideNode.equivTo(lvalue) && arg0 instanceof StringConstant) {
				if (argc == 2) {
					...
					if (arg1 instanceof FloatConstant) {
						return new IntentGetFloatEdge(((StringConstant) arg0).value, ((FloatConstant) arg1).value);
					}
				}
				return new IntentGetFloatEdge(((StringConstant) arg0).value);
			}
		}
