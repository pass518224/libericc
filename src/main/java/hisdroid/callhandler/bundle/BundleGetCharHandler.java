...
public class BundleGetCharHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.os.Bundle", "char getChar(java.lang.String)"));
		targets.add(new MethodSig("android.os.Bundle", "char getChar(java.lang.String,char)"));
		return targets;
	}
