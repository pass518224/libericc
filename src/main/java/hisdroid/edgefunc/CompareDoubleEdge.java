 ...
 *
 */
public class CompareDoubleEdge extends EdgeFunctionTemplate {
	DoubleConstant c;
	boolean reversed;
	// true: value cmp constant
	// false: constant cmp value
	
	public CompareDoubleEdge(DoubleConstant constant, boolean reversed) {
		c = constant;
		this.reversed = reversed;
	}
	
	public CompareDoubleEdge(CompareDoubleEdge old, EdgeFunction<GeneralValue> next) {
		c = old.c;
	...
	public EdgeFunctionTemplate copy(){
		return new CompareDoubleEdge(this, next);
	}
	...
	public EdgeFunction<GeneralValue> joinWithFirstEdge(EdgeFunction<GeneralValue> otherFunction){
		if (otherFunction instanceof CompareDoubleEdge) {
			CompareDoubleEdge otherEdge = (CompareDoubleEdge) otherFunction;
	...
	public boolean equalToFirstEdge(EdgeFunction<GeneralValue> other) {
		if (other instanceof CompareDoubleEdge) {
			CompareDoubleEdge otherEdge = (CompareDoubleEdge) other;
	...
	public String edgeToString(){
		if (!reversed) {
			return "CompareDoubleEdge(DoubleValue, "+c+")";
		}
		else {
			return "CompareDoubleEdge("+c+", DoubleValue)";
		}
	}
}
