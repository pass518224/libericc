...
import libericc.edgefunc.intent.IntentGetLongEdge;
...
public class IntentGetLongHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.content.Intent", "long getLongExtra(java.lang.String,long)"));
		return targets;
	}
