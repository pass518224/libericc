...
import libericc.edgefunc.intent.IntentGetShortEdge;
...
public class IntentGetShortHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.content.Intent", "short getShortExtra(java.lang.String,short)"));
		return targets;
	}
