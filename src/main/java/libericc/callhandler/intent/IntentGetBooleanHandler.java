...
import libericc.edgefunc.intent.IntentGetBooleanEdge;
...
public class IntentGetBooleanHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.content.Intent", "boolean getBooleanExtra(java.lang.String,boolean)"));
		return targets;
	}
