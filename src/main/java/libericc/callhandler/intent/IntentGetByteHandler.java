...
import libericc.edgefunc.intent.IntentGetByteEdge;
...
public class IntentGetByteHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.content.Intent", "byte getByteExtra(java.lang.String,byte)"));
		return targets;
	}
