...
import libericc.edgefunc.intent.IntentGetIntEdge;
...
public class IntentGetIntHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.content.Intent", "int getIntExtra(java.lang.String,int)"));
		return targets;
	}
