...
import libericc.edgefunc.intent.IntentGetFloatEdge;
...
public class IntentGetFloatHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.content.Intent", "float getFloatExtra(java.lang.String,float)"));
		return targets;
	}
