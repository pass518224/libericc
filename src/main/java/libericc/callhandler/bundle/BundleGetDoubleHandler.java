...
import libericc.edgefunc.bundle.BundleGetDoubleEdge;
...
public class BundleGetDoubleHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.os.Bundle", "double getDouble(java.lang.String)"));
		targets.add(new MethodSig("android.os.Bundle", "double getDouble(java.lang.String,double)"));
		return targets;
	}
