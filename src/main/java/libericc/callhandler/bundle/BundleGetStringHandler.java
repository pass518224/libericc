package libericc.callhandler.bundle;
...
import libericc.edgefunc.bundle.BundleGetStringEdge;
...
public class BundleGetStringHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.os.Bundle", "java.lang.String getString(java.lang.String)"));
		targets.add(new MethodSig("android.os.Bundle", "java.lang.String getString(java.lang.String,java.lang.String)"));
		return targets;
	}
			...
			if (callNode.equivTo(base) && returnSideNode.equivTo(lvalue) && arg0 instanceof StringConstant) {
				if (argc == 2) {
					...
					if (arg1 instanceof StringConstant) {
						return new BundleGetStringEdge(((StringConstant) arg0).value, ((StringConstant) arg1).value);
					}
				}
				return new BundleGetStringEdge(((StringConstant) arg0).value);
			}
		}
