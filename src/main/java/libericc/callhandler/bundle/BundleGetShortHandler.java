...
import libericc.edgefunc.bundle.BundleGetShortEdge;
			...
			if (callNode.equivTo(base) && returnSideNode.equivTo(lvalue) && arg0 instanceof StringConstant) {
				if (argc == 2) {
					...
					if (arg1 instanceof IntConstant) {
						return new BundleGetShortEdge(((StringConstant) arg0).value, (short)((IntConstant) arg1).value);
					}
				}
				return new BundleGetShortEdge(((StringConstant) arg0).value);
			}
		}
