...
import libericc.edgefunc.bundle.BundleGetLongEdge;
...
public class BundleGetLongHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.os.Bundle", "long getLong(java.lang.String)"));
		targets.add(new MethodSig("android.os.Bundle", "long getLong(java.lang.String,long)"));
		return targets;
	}
