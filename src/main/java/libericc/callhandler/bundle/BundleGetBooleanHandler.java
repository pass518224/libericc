...
import libericc.edgefunc.bundle.BundleGetBooleanEdge;
...
public class BundleGetBooleanHandler extends CallHandler {
	@Override
	public Set<MethodSig> getTargets(){
		Set<MethodSig> targets = new HashSet<MethodSig>();
		targets.add(new MethodSig("android.os.Bundle", "boolean getBoolean(java.lang.String)"));
		targets.add(new MethodSig("android.os.Bundle", "boolean getBoolean(java.lang.String,boolean)"));
		return targets;
	}
